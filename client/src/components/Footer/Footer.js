                ...
                <div className="footer__items__container">
                    <div className="footer__help__container">
                        ...
                        <ul className="fotter__help__links">
                            ...
                            <li className="help__link"><a href="/">Accessiblity</a></li>
                        </ul>
                    </div>
                    ...
                    <ul className="footer__social__links">
                            <li className="social__link"><TwitterIcon /> </li>
                            <li className="social__link"> <InstagramIcon /></li>
                            <li className="social__link"><YouTubeIcon /></li>
                            <li className="social__link"><TelegramIcon /></li>
                            <li className="social__link"><PinterestIcon /></li>
                        </ul>
                    </div>
                </div>
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2024 Poornima Ltd. |</li>
